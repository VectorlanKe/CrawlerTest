...
namespace SmallCrawler
{
    public class Crawler : ICrawler
    {
        ...
        /// 爬虫启动事件
        /// </summary>
        public event EventHandler<OnStartEventModel> OnStart;
        /// <summary>
        /// 爬虫完成事件
        /// </summary>
        public event EventHandler<OnCompletedEventModel> OnCompleted;
        /// <summary>
        /// 爬虫出错事件
        /// </summary>
        public event EventHandler<OnErrorEventModel> OnError;
        /// <summary>
        /// 定义Cookie容器
        /// </summary>
        ...
        public async Task<string> Start(Uri uri, string proxy=null)
        {
            return await Task.Run(() =>
            {
                ...
                try
                {
                    if (this.OnStart != null) this.OnStart(this, new OnStartEventModel(uri));
                    ...
                    if (this.OnCompleted != null) this.OnCompleted(this, new OnCompletedEventModel(uri, threadId, milliseconds, pageSource));
                }
                catch (Exception ex)
                {
                    if (this.OnError != null) this.OnError(this, new OnErrorEventModel(uri, ex));
                }
                return pageSource;
            });
        }
